<template>
  <div class="page-hero relative mb-10 pt-20 pb-10">
    <div class="container relative max-w-[1260px]">
      <div v-if="data">
        <Subheading :label="data.name" class="[&]:mb-1" data-aos="fade-down" :data-aos-delay="500">
          <template v-slot:icon>
            <font-awesome icon="terminal" />
          </template>
        </Subheading>
        <Heading :label="data.headline" class="[&]:m-0" data-aos="fade-right" :data-aos-delay="500" />
