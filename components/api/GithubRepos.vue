<template>
  <div>
    <div class="grid xl:grid-cols-3 grid-cols-1 gap-8 xl:max-w-full max-w-3xl mx-auto">
      <Card v-for="(item, index) in data" :key="index" data-aos="fade-down" :data-aos-delay="(index + 1) * 150">
        <span
