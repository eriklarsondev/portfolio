<template>
  <div>
    <div
      class="grid xl:grid-cols-3 grid-cols-1 xl:gap-x-10 xl:gap-y-20 gap-y-10 xl:max-w-full max-w-3xl mx-auto"
      ...
      <div
        ...
        <div class="inline-block mt-2 ml-3 text-left" v-if="item.content">
          <span
